            ...
            <div class="container">
                ...
                <form action="TFPCadmin" method="post">
                    <table >
                        ...
                        <tr>
                            <td>Subject ID </td>
                            <td><input type="text" name="sbIDAdd"></td>
                        </tr>  
                        <tr>
                            <td>Subject Name</td>
                            <td><input type="text" name="sbNameAdd"></td>
                        </tr>  
                        <tr>
                            <td>Number Credits</td>
                            <td><input type="text" name="nbCrAdd"></td>
                        </tr>  
                        <tr>
                            <td>Fee</td>
                            <td><input type="text" name="feeAdd"></td>
                        </tr>  
                        <tr>
                            <td>Fee International</td>
                            <td><input type="text" name="feeInterAdd"></td>
                        </tr>  
