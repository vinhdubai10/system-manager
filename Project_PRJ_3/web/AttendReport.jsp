        ...
        ================================================== -->
            <div class="container">
                <form action="mark" method="post">
                    ...
                    <h3>Attend Report Detail:</h3><br><br>
                    <table border="1" style="width: 100%">
                        ...
                        <c:forEach items="${listA}" var="item">
                            <tr>
                                ...
                                <td>${item.getSubID()}</td>
                                <td>${item.getAbsentDay()}</td>
                                <td>${item.getAbsentRate()}</td>
                                
                            </tr>
                        </c:forEach>
                    </table>
                    <br>
                    <strong>Note:</strong> If your absent rate is <strong style="color: red">more than 20%</strong>, then you cannot take the final exam.
