...
<html>
    ...
    <body class="layout-default">
        ...
        ================================================== -->
            <div class="container">
                <form action="appvad" method="post">
                    <h2>Response Application</h2>
                    <table >
                        <tr>
                            <td>Message ID:</td>
                            <td>
                                <select name="messID">
                                    <c:forEach items="${listUID}" var="item">
                                        <option value="${item.getAppID()}">${item.getAppID()}</option>
                                    </c:forEach>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td>Response:</td>
                            <td>
                                <textarea name="response" rows="10" cols="50"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>Date Response:</td>
