...
<html>
    ...
    <body class="layout-default">
        ...
        ================================================== -->
            <div class="container">
                <h2>Tuition fee per course</h2>
                <form action="TFPCadmin" method="get">
                    <input type="submit" name="add" value="Add Subject">
                    <table border="1" style="width: 100%">
                        <tr>
                            <td style="font-weight: bold">SubjectID</td>
                            <td style="font-weight: bold">SubjectName</td>
                            <td style="font-weight: bold">NumberCredits</td>
                            <td style="font-weight: bold">Fee</td>
                            <td style="font-weight: bold">FeeInternational</td>
                        ...
                        <c:forEach items="${listS}" var="item">
                            <tr>
                                ...
                                <td>${item.getNumberCredits()}</td>
                                <td>${item.getFee()}</td>
                                <td>${item.getFeeInternational()}</td>
